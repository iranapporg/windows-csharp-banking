    ...
    public partial class frmzamen : Form
    {
        ...
        public void autocomplete(string sId)
        {
            ...
            if (d1 != null && d1.Rows.Count > 0)
            {
                ...
                if (blnIsZamenInf == true)
                    ...
                    d3 = db1.ReportRecord("SELECT * FROM tbl_info_sanad WHERE id_person_fk = '" + id + "'");
                ...
                if (d3 != null && d3.Rows.Count > 0)
                {
                    ...
                    txtdate.Text = d3.Rows[0][6].ToString();
                    txtdate1.Text = d3.Rows[0][7].ToString();
                    txtexpire.Text = d3.Rows[0][8].ToString();
                    txtaccounttype.Text = d3.Rows[0][9].ToString();
                    txtdateeftetah.Text = d3.Rows[0][10].ToString();
                    txtaccountnumber1.Text = d3.Rows[0][11].ToString();
                    txtcodeetebari.Text = d3.Rows[0][12].ToString();
                }
            }
            else
            {
        ...
        private void fillDataZamen()
        {
            if (Zamens.Zamen1 == true && Zamens.Zamen2 == false)
            {
                ...
                Zamen.txtshomaremojavez = txtdate.Text;
                Zamen.txtdatemojavez = txtdate1.Text;
